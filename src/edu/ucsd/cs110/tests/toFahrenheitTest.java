...
import edu.ucsd.cs110.temperature.toFahrenheit;
import edu.ucsd.cs110.temperature.Temperature;
import junit.framework.TestCase;

public class toFahrenheitTest extends TestCase{
    private float delta = 0.001f;

    public void testFahrenheit(){
        float value = 12.34f;
        toFahrenheit temp = new toFahrenheit(value);
    ...
    {
        toFahrenheit temp = new toFahrenheit(32);
